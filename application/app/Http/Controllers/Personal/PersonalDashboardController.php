...
class PersonalDashboardController extends Controller
{
    public function index() 
    {
        ...
        $a = table::attendance()->where('reference', $id)->latest('date')->take(2)->get();
        ...
        return view('personal.personal-dashboard', compact('cs', 'tasks', 'ps', 'al', 'pl', 'ald', 'a', 'la', 'ed', 'tf'));
    }
}
