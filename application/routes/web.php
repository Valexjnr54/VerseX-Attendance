		...
		*/
		...
		Route::group(['middleware' => 'admin'], function () {
			...
			*/
			...
			|--------------------------------------------------------------------------
			*/
			Route::get('tasks', 'Admin\TasksController@index')->name('task');
			Route::post('tasks/add', 'Admin\TasksController@add');
			Route::get('tasks/edit/{id}', 'Admin\TasksController@edit');
			Route::post('tasks/update', 'Admin\TasksController@update');
			Route::get('tasks/delete/{id}', 'Admin\TasksController@delete');
			Route::get('tasks/archive/{id}', 'Admin\TasksController@archive');
		...
		Route::group(['middleware' => 'employee'], function () {
			...
			*/
			...
			Route::get('personal/tasks/incomplete/{id}', 'Personal\PersonalTasksController@incomplete');
			Route::post('personal/tasks/incomplete', 'Personal\PersonalTasksController@incompleteupdate');
			Route::get('personal/tasks/complete/{id}', 'Personal\PersonalTasksController@completeupdate');
			// Route::get('get/personal/schedules', 'Personal\PersonalSchedulesController@getPS');
