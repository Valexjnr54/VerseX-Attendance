        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
                <div class="info-box">
                    <span class="info-box-icon bg-aqua"><i class="ui icon user circle"></i></span>
                    <div class="info-box-content">
                        <span class="info-box-text">{{ __("Tasks") }}</span>
                        <div class="progress-group">
                            <div class="progress sm">
                                <div class="progress-bar progress-bar-aqua" style="width: 100%"></div>
                            </div>
                            <div class="stats_d">
                                <table style="width: 100%;"  class="table table-striped nobordertop">
                                    <thead>
                                        <tr>
                                            <th class="text-left col-4">{{ __('Task') }}</th>
                                            <th class="text-right col-4">{{ __('Task End Date') }}</th>
                                            <th class="text-right col-4">{{ __('Task End Date') }}</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="text-left col-4">{{ $task->task }}</td>
                                            <td class="text-right col-4">{{ $task->taskdateend }}</td>
                                            <td class="text-right col-4">{{ $task->taskdateend }}</td>
                                        </tr>
                                        @endforeach
                                        @endisset
